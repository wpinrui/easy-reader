...
Live at https://wpinrui.github.io/easy-reader/
...
- **Shareable links.** The text is compressed into the URL hash, so `https://wpinrui.github.io/easy-reader/#<payload>` opens it anywhere. Nothing is uploaded: the hash never leaves the browser.
